...
<cfset application.dsource="onli16_gallart">
<cfset dsource="onli16_gallart">
...
<cfscript>
	application.dsource='onli16_gallart';
	application.dbuname='onli16_gallart';
	application.dbpword='re3objec';
...
<cfscript>
	application.mailserver='mail2.onlinegalleryart.com';
	application.mailserver_un='onli16@onlinegalleryart.com';
	application.mailserver_pw='re3objec';
</cfscript>

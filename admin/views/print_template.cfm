							...
							<div style=" ##position: absolute; ##top: 50%;display: table-cell; vertical-align: middle;">
								<div style="##position: relative; ##top: -50%">
									<div class="imgContainer">
										<div class="gallartLogo"><img src="http://#server_name#/images/gallart.gif" /></div>
										<div class="listingImage"><img src="http://#server_name#/img/thumbnails/#uid#.jpg" class="resize" height="50"  /></div>
										<div>&nbsp;</div>
									</div>

    ...
    <table border = "0" width = "100%" cellpadding = "5" cellspacing = "0">
        ...
        <tr>
                ...
                <table cellspacing="5" cellpadding="1" border="0" width="100%">
                    ...
                    <tr>
                        <td colspan="3" align="center"><br>
                            <!--- <cfinput type="button" name="exportBtn" value="Export to CSV" onclick="document.location.href='https://gallart.com/admin/views/orders/manage/exportOrder.cfm';" /> --->

                            <cfinput type="submit" name="exportBtn" value="Export to CSV" formaction="https://gallart.com/admin/views/orders/manage/exportOrder.cfm" formmethod="post" />
            ...
            <td valign="top">
                ...
                <!--- <cfinput type="hidden" name="searchcountryValue"> --->

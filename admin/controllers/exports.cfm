...
<cfswitch expression="#Action#">
	...
	<!--- Adding for artist by csv --->
	<cfcase value="createCSVFile">

		<cfscript>
			getCsvListingsByArtist = application.objectFactoryAdmin.getInstance('art').getCsvListingsByArtist( url.artists );
		</cfscript>	
	
		<cfinclude template="#ViewPath#/create_csv_file.cfm">

...
<cfsilent>
 ...
 <html>
	<head>
	   <cfoutput>
	   <cfset productID = ListLast(CGI.QUERY_STRING, "-")>
		<cfif FindNoCase("untitled", titletext)>
			<cfset titletext = "Artwork ##" & productID>
		</cfif>
												...
												<div class="item-text-content">
													<div class="top-heading">
													    ...
													    <cfif productinfo.name gt 0 OR productinfo.name NEQ ''>
															...
															<cfif updatedName EQ 'Untitled'>
																<cfset updatedName = Trim(productinfo.modelno)>
															</cfif>

...
<cfoutput>
    ...
    <ul>
        <li><strong>Product Name:</strong> #server.coldfusion.productName#</li>
        <li><strong>Product Version:</strong> #server.coldfusion.productVersion#</li>
        <li><strong>Java Version:</strong> #server.coldfusion.javaVersion#</li>
        <li><strong>OS:</strong> #server.os.name# #server.os.version#</li>
        <li><strong>Server Software:</strong> #cgi.server_software#</li>
    </ul>
</cfoutput>

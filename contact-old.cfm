...
<form method="post" action="#script_name#?xss=#xss#" name="errorFrm">
						...
						<cfif FORM.submitted>	
							...
							<cfif blnIsBot>
			 					<cfoutput>
									<script language="JavaScript">
										...
										document.errorFrm.email.value = '#form.phone#'
							...
							<cfelse>
								...
								<cftry>
									...
									insert into leads (fname,lname, notes, email, phone, maillist)
										values('#form.fname#','#form.lname#', '#form.comments#', '#form.email#', '#form.phone#', '#form.list#')
									</cfquery>
	...
	password="r3eOteC" to="#emailsupport#" cc="#emailsupportcc#"  from="#form.email#" subject="GallArt.com <> Buying & Selling Fine Art <> Contact Form" type="HTML">
						...
						<TR>
							<TD><FONT face="verdana,arial,helvetica" color="000000" size="-2"><b>PHONE</b></FONT><br><cfinput type="text" size=40 maxsize=50 name="phone" value="#form.phone#" required="No" MESSAGE="Please fill in your email address."></TD>
							<td width="75">&nbsp;</td>
						</TR>
						<TR>
